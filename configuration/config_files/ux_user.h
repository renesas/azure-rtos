...
#define USE_UX_THREAD_STACK_SIZE                            0
#if USE_UX_THREAD_STACK_SIZE
#define UX_THREAD_STACK_SIZE                                (2 * 1024) 
#endif

/* Define USBX Host Enum Thread Stack Size. The default is to use UX_THREAD_STACK_SIZE */

#define USE_UX_HOST_ENUM_THREAD_STACK_SIZE                  0
#if USE_UX_HOST_ENUM_THREAD_STACK_SIZE
...
#define USE_UX_HOST_HCD_THREAD_STACK_SIZE                   0
#if USE_UX_HOST_HCD_THREAD_STACK_SIZE
...
#define USE_UX_HOST_HNP_POLLING_THREAD_STACK                0
#if USE_UX_HOST_HNP_POLLING_THREAD_STACK
...
#define USE_UX_PERIODIC_RATE_BY_TX                           1
#if USE_UX_PERIODIC_RATE_BY_TX
...
#define USE_UX_CONTROL_TRANSFER_TIMEOUT                      0
#if USE_UX_CONTROL_TRANSFER_TIMEOUT
...
#define USE_UX_NON_CONTROL_TRANSFER_TIMEOUT                 0
#if USE_UX_NON_CONTROL_TRANSFER_TIMEOUT
...
#define USE_UX_MAX_CLASSES                                  0
#if USE_UX_MAX_CLASSES
...
#define USE_UX_MAX_SLAVE_CLASS_DRIVER                       0
#if USE_UX_MAX_SLAVE_CLASS_DRIVER
#define UX_MAX_SLAVE_CLASS_DRIVER                           1
#endif

/* Defined, this value is the maximum number of interfaces in the device framework.  */

#define USE_UX_MAX_SLAVE_INTERFACES                         0
#if USE_UX_MAX_SLAVE_INTERFACES
...
#define USE_UX_MAX_DEVICES                                  0
#if USE_UX_MAX_DEVICES
...
#define USE_UX_MAX_SLAVE_LUN                                0
#if USE_UX_MAX_SLAVE_LUN
...
#define USE_UX_MAX_HOST_LUN                                 0
#if USE_UX_MAX_HOST_LUN
...
#define USE_UX_SLAVE_REQUEST_CONTROL_MAX_LENGTH             0
#if USE_UX_SLAVE_REQUEST_CONTROL_MAX_LENGTH
...
#define USE_UX_SLAVE_REQUEST_DATA_MAX_LENGTH                1
#if USE_UX_SLAVE_REQUEST_DATA_MAX_LENGTH
...
#define USE_UX_SLAVE_CLASS_STORAGE_INCLUDE_MMC              0
#if USE_UX_SLAVE_CLASS_STORAGE_INCLUDE_MMC
...
#define USE_UX_HOST_CLASS_STORAGE_MEMORY_BUFFER_SIZE        1
#if USE_UX_HOST_CLASS_STORAGE_MEMORY_BUFFER_SIZE
...
#define USE_UX_HOST_CLASS_STORAGE_THREAD_STACK_SIZE         0
#if USE_UX_HOST_CLASS_STORAGE_THREAD_STACK_SIZE
...
#define	USE_UX_MAX_ED                                       1
#if USE_UX_MAX_ED
#define UX_MAX_ED                                           80
#endif

#define USE_UX_MAX_TD                                       1
#if	USE_UX_MAX_TD
#define UX_MAX_TD                                           128
#endif

#define USE_UX_MAX_ISO_TD                                   1
#if USE_UX_MAX_ISO_TD
...
#define USE_UX_HOST_CLASS_HID_DECOMPRESSION_BUFFER          1
#if USE_UX_HOST_CLASS_HID_DECOMPRESSION_BUFFER
...
#define USE_UX_HOST_CLASS_HID_USAGES                        1
#if USE_UX_HOST_CLASS_HID_USAGES
...
#define USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE                               0
#if USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE
...
#define USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE_REPORT_KEY_DOWN_ONLY           0
#if USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE_REPORT_KEY_DOWN_ONLY
...
#define USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE_REPORT_LOCK_KEYS               0
#if USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE_REPORT_LOCK_KEYS
...
#define USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE_REPORT_MODIFIER_KEYS           0
#if USE_UX_HOST_CLASS_HID_KEYBOARD_EVENTS_KEY_CHANGES_MODE_REPORT_MODIFIER_KEYS
...
#define USE_UX_HOST_CLASS_STORAGE_MAX_MEDIA                 1
#if USE_UX_HOST_CLASS_STORAGE_MAX_MEDIA
...
#define USE_UX_HOST_CLASS_STORAGE_INCLUDE_LEGACY_PROTOCOL_SUPPORT            0
#if USE_UX_HOST_CLASS_STORAGE_INCLUDE_LEGACY_PROTOCOL_SUPPORT
...
#define USE_UX_ENFORCE_SAFE_ALIGNMENT                       0
#if USE_UX_ENFORCE_SAFE_ALIGNMENT
...
#define USE_UX_DEVICE_CLASS_CDC_ECM_NX_PKPOOL_ENTRIES       1
#if USE_UX_DEVICE_CLASS_CDC_ECM_NX_PKPOOL_ENTRIES
...
#define USE_UX_HOST_CLASS_CDC_ECM_NX_PKPOOL_ENTRIES         0
#if USE_UX_HOST_CLASS_CDC_ECM_NX_PKPOOL_ENTRIES
...
#define USE_UX_HOST_CLASS_CDC_ECM_PACKET_POOL_WAIT          0
#if USE_UX_HOST_CLASS_CDC_ECM_PACKET_POOL_WAIT
#define UX_HOST_CLASS_CDC_ECM_PACKET_POOL_WAIT              10
#endif

/* Defined, this value represents the number of milliseconds to wait for packet pool availability checking loop.
   The default is 100 milliseconds.
*/

#define USE_UX_HOST_CLASS_CDC_ECM_PACKET_POOL_INSTANCE_WAIT     0
#if USE_UX_HOST_CLASS_CDC_ECM_PACKET_POOL_INSTANCE_WAIT
...
#define USE_UX_HOST_CLASS_CDC_ECM_USE_PACKET_POOL_FROM_NETX     0
#if USE_UX_HOST_CLASS_CDC_ECM_USE_PACKET_POOL_FROM_NETX
...
#define USE_UX_DEVICE_CLASS_CDC_ECM_PACKET_POOL_WAIT         0
#if USE_UX_DEVICE_CLASS_CDC_ECM_PACKET_POOL_WAIT
...
#define USE_UX_DEVICE_CLASS_HID_EVENT_BUFFER_LENGTH         0
#if USE_UX_DEVICE_CLASS_HID_EVENT_BUFFER_LENGTH
...
#define USE_UX_DEVICE_CLASS_HID_MAX_EVENTS_QUEUE            0
#if USE_UX_DEVICE_CLASS_HID_MAX_EVENTS_QUEUE
#define UX_DEVICE_CLASS_HID_MAX_EVENTS_QUEUE                8
#endif

/* Defined, this macro will disable DFU_UPLOAD support.  */

#define USE_UX_DEVICE_CLASS_DFU_UPLOAD_DISABLE              0
#if USE_UX_DEVICE_CLASS_DFU_UPLOAD_DISABLE
#define UX_DEVICE_CLASS_DFU_UPLOAD_DISABLE 
#endif

/* Defined, this macro will enable DFU_GETSTATUS and DFU_GETSTATE in dfuERROR.  */

#define USE_UX_DEVICE_CLASS_DFU_ERROR_GET_ENABLE            0
#if USE_UX_DEVICE_CLASS_DFU_ERROR_GET_ENABLE
...
#define USE_UX_DEVICE_CLASS_DFU_STATUS_MODE                    0
#if USE_UX_DEVICE_CLASS_DFU_STATUS_MODE
...
#define USE_UX_DEVICE_CLASS_DFU_STATUS_POLLTIMEOUT             0
#if USE_UX_DEVICE_CLASS_DFU_STATUS_POLLTIMEOUT
#define UX_DEVICE_CLASS_DFU_STATUS_POLLTIMEOUT                 (1)
#endif

/* Defined, this macro will enable custom request process callback.  */

#define USE_UX_DEVICE_CLASS_DFU_CUSTOM_REQUEST_ENABLE           0
#if USE_UX_DEVICE_CLASS_DFU_CUSTOM_REQUEST_ENABLE
#define UX_DEVICE_CLASS_DFU_CUSTOM_REQUEST_ENABLE
#endif

/* Defined, this macro disables CDC ACM non-blocking transmission support.  */

#define USE_UX_DEVICE_CLASS_CDC_ACM_TRANSMISSION_DISABLE        0
#if USE_UX_DEVICE_CLASS_CDC_ACM_TRANSMISSION_DISABLE
#define UX_DEVICE_CLASS_CDC_ACM_TRANSMISSION_DISABLE 
#endif

/* Defined, this macro enables device bi-directional-endpoint support.  */

#define USE_UX_DEVICE_BIDIRECTIONAL_ENDPOINT_SUPPORT            0
#if USE_UX_DEVICE_BIDIRECTIONAL_ENDPOINT_SUPPORT 
#define UX_DEVICE_BIDIRECTIONAL_ENDPOINT_SUPPORT  
#endif

/* Defined, this value will only enable the host side of usbx.  */

#define USE_UX_HOST_SIDE_ONLY                                   0
#if USE_UX_HOST_SIDE_ONLY
#define UX_HOST_SIDE_ONLY  
#endif

/* Defined, this value will only enable the device side of usbx.  */

#define USE_UX_DEVICE_SIDE_ONLY                                 0
#if USE_UX_DEVICE_SIDE_ONLY
...
#define USE_UX_OTG_SUPPORT                                      0
#if USE_UX_OTG_SUPPORT
...
#define USE_UX_HOST_CLASS_STORAGE_MAX_TRANSFER_SIZE             1
#if USE_UX_HOST_CLASS_STORAGE_MAX_TRANSFER_SIZE
...
#define USE_UX_DEBUG_LOG_SIZE                                   1
#if USE_UX_DEBUG_LOG_SIZE
...
#define USE_UX_ENABLE_ASSERT                                    1
#if USE_UX_ENABLE_ASSERT
...
#define USE_UX_ASSERT_FAIL                                      0
#if USE_UX_ASSERT_FAIL
...
#define USE_UX_INCLUDE_USER_DEFINE_BSP                          0
#if USE_UX_INCLUDE_USER_DEFINE_BSP
#define UX_INCLUDE_USER_DEFINE_BSP
