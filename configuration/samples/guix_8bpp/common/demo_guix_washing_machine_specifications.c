...
/*  Date (dd.mm.yyyy): 15. 9.2021   Time (hh:mm): 18:39                        */
/*******************************************************************************/
...
GX_STUDIO_DISPLAY_INFO demo_guix_washing_machine_display_table[1] =
{
    ...
    139264,                                  /* canvas memory size in bytes    */
...
GX_PROMPT_PROPERTIES temperature_window_water_t_cold_properties =
{
    ...
    GX_COLOR_ID_AA_TEXT_NORMAL,              /* normal text color              */
    GX_COLOR_ID_AA_TEXT_NORMAL,              /* selected text color            */
...
GX_PROMPT_PROPERTIES temperature_window_water_t_hot_properties =
{
    ...
    GX_FONT_ID_NORMAL,                       /* font id                        */
    GX_COLOR_ID_AA_TEXT_NORMAL,              /* normal text color              */
    GX_COLOR_ID_AA_TEXT_SELECTED,            /* selected text color            */
    GX_COLOR_ID_LIGHT_GRAY                   /* disabled text color            */
};
...
GX_PROMPT_PROPERTIES temperature_window_water_label_2_properties =
{
    ...
    GX_FONT_ID_NORMAL,                       /* font id                        */
    GX_COLOR_ID_AA_TEXT_SELECTED,            /* normal text color              */
    GX_COLOR_ID_AA_TEXT_SELECTED,            /* selected text color            */
    GX_COLOR_ID_AA_TEXT_SELECTED             /* disabled text color            */
};
...
GX_PROMPT_PROPERTIES water_level_window_water_level_label_properties =
{
    ...
    GX_COLOR_ID_AA_TEXT_NORMAL,              /* normal text color              */
    GX_COLOR_ID_AA_TEXT_NORMAL,              /* selected text color            */
    GX_COLOR_ID_AA_TEXT_NORMAL               /* disabled text color            */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_day_of_week_define =
{
    ...
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_DRAW_SELECTED|GX_STYLE_TEXT_COPY|GX_STYLE_TEXT_LEFT,   /* style flags */
    0,                                       /* status flags                   */
    sizeof(GX_PROMPT),                       /* control block size             */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* normal color id                */
...
UINT _gx_rx_display_driver_setup(GX_DISPLAY *display)
{
    _gx_display_driver_8bit_palette_setup(display, GX_NULL, _gx_rx_buffer_toggle_8bpp);
