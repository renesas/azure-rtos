...
VOID washer_on_page_init()
{
    ...
    gx_widget_attach((GX_WIDGET *) &main_screen, &main_screen.main_screen_washer_on_window);
    INT old_selected_index;
...
VOID washer_mode_label_widgets_update(int old_selected_index)
{
    ...
    gx_prompt_text_color_set((GX_PROMPT *)washer_mode_label_widgets[old_selected_index], GX_COLOR_ID_AA_TEXT_NORMAL, GX_COLOR_ID_AA_TEXT_NORMAL, GX_COLOR_ID_AA_TEXT_NORMAL);

    /* Set new selected mode label color to green. */
    gx_prompt_text_color_set((GX_PROMPT *)washer_mode_label_widgets[selected_index], GX_COLOR_ID_AA_TEXT_SELECTED, GX_COLOR_ID_AA_TEXT_SELECTED, GX_COLOR_ID_AA_TEXT_SELECTED);
