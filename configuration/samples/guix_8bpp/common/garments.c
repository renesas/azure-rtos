...
VOID garments_page_init()
{
    ...
    gx_widget_attach((GX_WIDGET *) &main_screen, &garments_window);
    ...
    gx_radial_slider_animation_start(&garments_window.garments_window_radial_slider, garments_mode_angles[6]);
}
...
VOID garments_mode_label_widgets_update(int old_selected_index)
{
    ...
    gx_prompt_text_color_set((GX_PROMPT *)garments_mode_label_widgets[old_selected_index], GX_COLOR_ID_AA_TEXT_NORMAL, GX_COLOR_ID_AA_TEXT_NORMAL, GX_COLOR_ID_AA_TEXT_NORMAL);

    /* Change new selected mode label color to orange. */
    gx_prompt_text_color_set((GX_PROMPT *)garments_mode_label_widgets[selected_index], GX_COLOR_ID_AA_TEXT_SELECTED, GX_COLOR_ID_AA_TEXT_SELECTED, GX_COLOR_ID_AA_TEXT_SELECTED);
