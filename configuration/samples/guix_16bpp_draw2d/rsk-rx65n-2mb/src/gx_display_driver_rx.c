...
USHORT   *visible_frame = (USHORT *) FRAME_BUF_BASE_ADDR_A;
USHORT   *working_frame = (USHORT *) FRAME_BUF_BASE_ADDR_B;
...
/*******************************************************************************************************************/
VOID gx_copy_visible_to_working(GX_CANVAS  *canvas, GX_RECTANGLE *copy)
{
...
void board_port_setting (void)
{
    ...
    PORTB.PODR.BIT.B7 = 1;  /* Back light */
    PORT9.PODR.BIT.B7 = 1;  /* Display */
    PORTB.PDR.BIT.B7  = 1;
    PORT9.PDR.BIT.B7  = 1;
...
UINT gx_rx_graphics_driver_setup(GX_DISPLAY *display)
{
    ...
    memset(working_frame, 0x00, IMAGE_WIDTH * IMAGE_HEIGHT * 2);
    memset(visible_frame, 0x00, IMAGE_WIDTH * IMAGE_HEIGHT * 2);
