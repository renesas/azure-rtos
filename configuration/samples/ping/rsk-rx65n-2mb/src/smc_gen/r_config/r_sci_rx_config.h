...
#define SCI_CFG_CH8_EN_TXI_NESTED_INT    (1)
...
#define SCI_CFG_CH8_EN_RXI_NESTED_INT    (1)
...
#define SCI_CFG_CH8_EN_TEI_NESTED_INT    (1)
...
#define SCI_CFG_CH8_EN_ERI_NESTED_INT    (1)
...
#define SCI_CFG_CH8_TX_BUFSIZ   (2180)
...
#define SCI_CFG_CH8_RX_BUFSIZ   (4096)
