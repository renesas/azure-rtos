...
/*  Date (dd.mm.yyyy):  1. 9.2021   Time (hh:mm): 13:11                        */
/*******************************************************************************/
...
UINT _gx_rx_display_driver_setup(GX_DISPLAY *display)
{
    _gx_display_driver_565rgb_setup(display, GX_NULL, _gx_rx_buffer_toggle);
