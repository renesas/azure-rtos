    ...
    <tool id="SWComponent" version="1.0.0.0">
        ...
        <configuration inuse="true" name="r_sci_rx">
            <component detailDescription="Multi-Channel Multi-Mode SCI Driver." display="r_sci_rx" id="r_sci_rx4.80" version="4.80">
                ...
                <gridItem id="SCI_CFG_CH11_EN_TXI_NESTED_INT" selectedIndex="1"/>
                <gridItem id="SCI_CFG_CH11_EN_RXI_NESTED_INT" selectedIndex="1"/>
                <gridItem id="SCI_CFG_CH11_EN_TEI_NESTED_INT" selectedIndex="1"/>
                <gridItem id="SCI_CFG_CH11_EN_ERI_NESTED_INT" selectedIndex="1"/>
