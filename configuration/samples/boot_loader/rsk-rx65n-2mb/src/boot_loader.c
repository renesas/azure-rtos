...
void main(void)
{
    ...
    module_version = R_FWUP_GetVersion();
    printf("-------------------------------------------------\r\n");
    printf("BOOTLOADER demo version %u.%u.%u \r\n",
            g_app_firmware_version.u.x.uc_major,
            g_app_firmware_version.u.x.uc_minor,
            g_app_firmware_version.u.x.us_build);
    printf("FWUP FIT module version %u.%02u\r\n",
            (uint32_t)(module_version >> 16),
            (uint32_t)(module_version & 0xFF));
