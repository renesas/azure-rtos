...
/* For RX6xx builds, VBUS needs to be enabled. */
#define UX_RX6XX_VBUS_ENABLE
...
CHAR                            _ux_version_id[] = 
                                    "Copyright (c) Microsoft Corporation. All rights reserved. * USBX RX6xx/CCRX Version 6.1 *";
#else
