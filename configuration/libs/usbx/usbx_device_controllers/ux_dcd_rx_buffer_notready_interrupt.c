...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_dcd_rx_buffer_notready_interrupt                PORTABLE C      */ 
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
ULONG       rx_brdy_register;
    ...
    rx_brdy_register = _ux_dcd_rx_register_read(dcd_rx, UX_RX_DCD_NRDYENB);
    ...
    _ux_dcd_rx_register_write(dcd_rx, UX_RX_DCD_NRDYENB, rx_brdy_register);
