...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_dcd_rx_buffer_ready_interrupt                   PORTABLE C      */ 
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
ULONG        rx_brdy_register;
    ...
    rx_brdy_register = _ux_dcd_rx_register_read(dcd_rx, UX_RX_DCD_BRDYENB);

    /* Enable or Disable ?  */
    if (flag == UX_DCD_RX_ENABLE)

        /* Set the appropriate endpoint number.  */
        rx_brdy_register |= (1ul << ed -> ux_dcd_rx_ed_index);
    ...
    /* Write the BRDY register.  */
    _ux_dcd_rx_register_write(dcd_rx, UX_RX_DCD_BRDYENB, rx_brdy_register);
